...
export function WaitlistCTA() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-primary-bg px-6 py-16">
      ...
      <div className="bg-inverse-bg relative mx-auto flex max-w-[1280px] flex-col items-center overflow-hidden rounded-[24px] px-6 py-16 text-center md:px-12">
        <div className="relative z-10 flex w-full max-w-[700px] flex-col items-center">
          ...
          <motion.p
            {...fadeUp(0.1)}
            className="mb-10 max-w-[540px] text-[16px] text-tertiary-b md:text-[18px]"
            style={{ fontFamily: "'Afacad', sans-serif" }}
          >
          ...
          >
            <div className="flex-1">
              <input
                ...
                onBlur={handleBlur}
                disabled={isPending}
                className={`h-13.5 w-full rounded-[10px] border bg-white px-5 text-primary-text transition-colors outline-none placeholder:text-disabled-text ${
                  emailError
                    ? "border-red-400"
                    : "border-transparent focus:border-link-hover-text"
                }`}
                style={{ fontFamily: "'Afacad', sans-serif" }}
              />
            </div>
