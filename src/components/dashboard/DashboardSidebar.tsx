  ...
  return (
    <>
      ...
      <aside
        ...
        className={`border-border bg-background fixed top-0 bottom-0 left-0 z-50 flex w-[210px] shrink-0 flex-col border-r transition-transform duration-300 sm:w-70 lg:sticky lg:top-(--topbar-height) lg:z-30 lg:h-[calc(100vh-var(--topbar-height))] lg:translate-x-0 ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="border-border flex h-19 items-center justify-between border-b px-4 lg:hidden">
          ...
          <button
            ...
            className="border-border cursor-pointer rounded-[8px] border p-2"
          >
            <X size={20} />
          </button>
        </div>
