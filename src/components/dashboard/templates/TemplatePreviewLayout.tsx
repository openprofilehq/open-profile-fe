...
export default function TemplatePreviewLayout({
  ...
  return (
    <div className="bg-secondary-bg text-primary-text flex min-h-screen flex-col pb-24 font-sans antialiased">
      ...
      <div className="border-inverse-b bg-inverse-bg/95 text-inverse-text sticky top-0 z-50 w-full border-b px-4 py-3 shadow-md backdrop-blur-md">
        <div className="mx-auto flex max-w-4xl flex-col items-center justify-between gap-3 text-center sm:flex-row sm:text-left">
          <div className="flex items-center gap-2">
            <span className="bg-brand-hover-bg flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-bold tracking-wider text-white uppercase">
              <Eye size={12} /> Preview
            </span>
