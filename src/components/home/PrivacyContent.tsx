...
export const tableOfContent: TableOfContentItem[] = [
  ...
  },
  {
    ...
    content:
      "We may update this Privacy Policy periodically to reflect changes in our practices, technologies, or legal obligations. Continued use of the Service after updates constitutes acceptance of the revised Privacy Policy. For questions, requests, or privacy-related concerns, contact: Open Profile Privacy Team. Email: openprofilehq@gmail.com. Support: openprofilehq@gmail.com",
  },
];
