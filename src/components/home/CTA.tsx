...
export function CTA() {
  ...
  return (
    <section className="bg-primary-bg px-4 py-24 md:px-8 md:py-26">
      <div className="mx-auto max-w-7xl">
        <div className="bg-brand relative mx-auto flex w-full max-w-6xl items-center justify-between overflow-hidden rounded-[24px] px-8 py-9 md:rounded-[32px] lg:px-16 lg:py-18">
          <div className="relative z-10 max-w-105 space-y-4">
            <h2 className="text-[28px] leading-[1.2] font-semibold tracking-tight text-span-text md:text-[32px] md:whitespace-nowrap">
              Be the profile people find first
            </h2>

            <p className="text-[14px] leading-relaxed font-normal text-span-text md:text-[15px]">
